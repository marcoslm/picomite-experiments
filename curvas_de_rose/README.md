...
- **curvas.bas**: Versión simple y más fluida/rápida de la animación de curvas de rose.
- **curvas_starfield.bas**: Añade un starfield de fondo, lo que da un resultado más dinámico pero reduce la fluidez de la animación en 2-4 frames (es mi versión favorita).
